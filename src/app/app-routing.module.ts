...
const childrenRoutes: VexRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'state',
        loadChildren: () => import('./pages/apps/state/state.module').then(m => m.StateModule),
      },

      {
        path: 'city',
        loadChildren: () => import('./pages/apps/city/city.module').then(m => m.CityModule),
      },
